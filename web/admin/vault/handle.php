<?php
	...
	SWITCH($QUERY) {				
		...
		CASE 'CATRELTAGS': ECHO $ISADMIN ? CAT::CATRELTAGS($DATA) : $NORIGHTS; BREAK;
		// TAGS
		...
		CASE 'GLOBSETPARAM': ECHO $ISSUPERADMIN ? GLOBS::SETPARAM($DATA) : $NORIGHTS;	BREAK;
		// GROUPS
		...
		CASE 'ADMINBFINDMISSINGPREVIEW': ECHO $ISSUPERADMIN ? MISSING::PREVIEW($DATA) : $NORIGHTS; BREAK;	
		CASE 'ADMINDELMISSINGPREVIEW': ECHO $ISSUPERADMIN ? MISSING::DELPREVIEW($DATA) : $NORIGHTS; BREAK;	
