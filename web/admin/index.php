...
<div class="container">
	...
	<div class="navbar-header hidden-xxs">
        <a href="#/"><img src="../visco_logo.svg" class="logo"></a>  <span class="head-title hidden-xs">Assets Library</span>
      </div>
	<div id="navbar3" class="navbar-default">
        <ul class="nav nav-buttons">         
          ...
          <li class="dropdown" ng-show="auth.rights > 0 && auth.browser != 'MXS'">
            <a href="" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" tooltip-popup-delay="200" uib-tooltip="User" tooltip-placement="bottom"><span class="glyphicon glyphicon-user"></span></a>					
		...
		<div class="padding-15">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item" ng-repeat="crumb in breadcrumbs" ng-class="{active: !$last}">
					<a ng-if="!$last" ng-href="{{crumb.url}}">{{crumb.name}}</a>
...
<div class="container">
	...
	<div class="col-sm-3 col-md-3 col-lg-3"> <br>
		<div class="list-group"> 
			<a href="#/global" class="list-group-item" ng-class="{active: section=='/global'}">Global</a> 
			<a href="#/category" class="list-group-item" ng-class="{active: section=='/category'}">Categories</a> 		
			<a href="#/models" class="list-group-item" ng-class="{active: section=='/models'}">Models</a> 		
			<a href="#/upload" class="list-group-item" ng-class="{active: section=='/upload'}">Upload</a> 		
		</div>
	</div>
