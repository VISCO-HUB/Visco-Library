...
<div class="dropdown clr">
	<div class="btn-group">
		<button type="button" class="btn btn-default">{{products.filter.cat.name || 'All'}}</button>
		...
		<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
			<li><a href="" ng-click="changeFilter({'catid': null})">All</a></li>
			<li class="divider"></li>
			<li class="dropdown-submenu" ng-repeat="cat in categories" ng-if="cat.type == 1"> <a tabindex="-1" data-toggle="dropdown" href="" no-click>{{cat.name}}</a>
				<ul class="dropdown-menu">
					<li class="dropdown-submenu" ng-repeat="sub1 in cat.child"> <a href="" no-click>{{sub1.name}}</a>
						<ul class="dropdown-menu">
							<li ng-repeat="sub2 in sub1.child"><a href="" ng-click="changeFilter({'catid': sub2.id})">{{sub2.name}}</a></li>
						</ul>
					</li>
				</ul>
			</li>
