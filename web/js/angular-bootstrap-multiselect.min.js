(function () {
    ...
    multiselect.directive('multiselect', ['$filter', '$document', '$rootScope', '$log', function ($filter, $document, $rootScope, $log) {
        return {
            restrict: 'AE',
            scope: {
                options: '=',
            ...
            link: function ($scope, $element, $attrs, $ngModelCtrl) {
                ...
                $scope.getButtonText = function () {
                    ...
                    if ($scope.selectedOptions && $scope.selectedOptions.length > 1) {
                        ...
                        return $scope.labels && $scope.labels.select ? $scope.labels.select : 'All Users';
                    }
                };
...
angular.module("multiselect.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("multiselect.html",
    ...
    "        <li><ul class=\"dropdown-menu dropdown-menu-form\" style=\"display:block;position:initial;overflow-y:auto;max-height:400px;width:100%;border:0;box-shadow:none;\">" + 
